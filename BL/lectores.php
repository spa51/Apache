...
$vent=$objconsulta->mostrar_lectores($conexion);
?>
<!doctype html>
<html lang="en">
  <head>
...
<div class="container py-5 col-md-5">
  ...
  <tbody>
        <?php while($row=mysqli_fetch_array($vent)){ ?>
          <tr>
          <td align="center"><?php echo $row['contador_lec'] ?></td>
          <td align="center"><?php echo $row['id_lector'] ?></td>
          <td align="center"><?php echo $row['nombre_lec'] ?></td>
          <td align="center"><?php echo $row['telefono'] ?></td>
          <td align="center"><?php echo $row['prestamos'] ?></td>
          <td align="center"><?php echo $row['multa'] ?></td>
          </tr>
  </tbody>
  <?php } ?>
</table>
