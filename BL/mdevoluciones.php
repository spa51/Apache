...
$vent=$objconsulta->mostrar_devoluciones($conexion);
?>
<!doctype html>
<html lang="en">
  <head>
...
<div class="container py-5 col-md-4">
  ...
  <table class="table">
  <h2> <em>Lista de devoluciones</em></h2>
  ...
  <tbody>
        <?php while($row=mysqli_fetch_array($vent)){ ?>
          ...
          <td align="center"><?php echo $row['fecha_prestamo'] ?></td>
          <td align="center"><?php echo $row['fecha_devolucion'] ?></td>
          </tr>
  </tbody>
  <?php } ?>
</table>
