...
<div class="container">
  <main>
    <div class="py-5 text-center">
      ...
      <h2>Prestamos</h2>
      <p class="lead">Formulario de Prestamos de libros</p>
    </div>
    ...
    <div class="row g-6">
      <div class="col-md-7 col-lg-8">
          ...
          <div class="row g-3">
            ...
            <div class="col-sm-6">
              <label for="fecha" class="form-label">Fecha de Prestamo</label>
              <input type="date" class="form-control" name="fecha_prestamo"  placeholder="" value="<? $fecha_actual?>" required="">
              <div class="invalid-feedback">
                Valid last name is required.
              </div>
            </div>
