...
$vent = $objconsulta->datostaxiintervalo($taxiplaca,$tfecha,$tfecha2,$conexion);
$kilop_query2 = $objconsulta->kiloplaca2($taxiplaca,$tfecha,$tfecha2,$conexion);
  ...
  <div class="d-flex justify-content-center row-cols-md-3 mb-3 text-center">
    ...
    margin-top: 10px;">
      ...
      <div class="card-body">
        ...
        <ul class="list-unstyled mt-3 mb-4">
          <li>Recorrido entre intervalo</li>
          <li><?= $kilop_value2?></li>
        </ul>
      </div>
    </div>
