...
<!-- Inicio -->
<form id="form1" name="form1" method="post" action="recibe_equipos.php">
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate="">
          <div class="row g-3">
            ...
            <div class="col-sm-6">
              <label for="nombres" class="form-label">ID Equipo</label>
