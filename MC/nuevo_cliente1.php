...
<div class="container">
  <main>
    <div class="py-5 text-center">
      ...
      <h2>Cliente</h2>
      <p class="lead">Formulario de Cliente.</p>
    </div>

    <div class="row g-6">
      <div class="col-md-7 col-lg-8">
        <h4 class="mb-3">Datos del Cliente</h4>
        <form id="form1" name="form1" method="post" action="recibe_clientes.php">
          <div class="row g-3">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="nombres" placeholder="" value="" required="">
              <div class="invalid-feedback">
