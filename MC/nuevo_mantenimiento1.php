...
<!-- Inicio -->
<form id="form1" name="form1" method="post" action="recibe_mantenimiento.php">
<div class="container">
  <main>
    <div class="py-5 text-center">
      <img class="d-block mx-auto mb-4" src="img/logo.png" alt="" width="72" height="57">
      <h2>Mantenimiento</h2>
      <p class="lead">Formulario de Mantenimiento.</p>
    </div>

    <div class="row g-6">
      <div class="col-md-7 col-lg-8">
        <h4 class="mb-3">Datos del Mantenimiento</h4>
        <form class="needs-validation" novalidate="">
          <div class="row g-3">
            <div class="col-sm-6">
              <label for="idcliente" class="form-label">Consecutivo</label>
              <input type="text" class="form-control" name="consecutivo" value="<?=$row['max'] ?>" readonly="false" placeholder="" value="" required="" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;">
            ...
            <div class="col-sm-6">
              <label for="nombres" class="form-label">ID del Tipo de Mantenimiento</label>
              <input type="text" class="form-control"  name="idtipo" placeholder="" value="" required="">
              <div class="invalid-feedback">
            ...
            <div class="col-sm-6">
              <label for="direccion" class="form-label">ID Equipo</label>
              <input type="text" class="form-control"  name="idequipo" placeholder="" value="" required="">
              <div class="invalid-feedback">
                Valid last name is required.
              </div>
            </div>
            ...
            <div class="col-sm-6">
              ...
              <input type="date" class="form-control" name="fecha"  placeholder="" value="" required="">
              <div class="invalid-feedback">
                Valid last name is required.
              </div>
            </div>
