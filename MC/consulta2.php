...
<!-- Inicio -->
<form id="form1" name="form1" method="post" action="mostrar_consulta2.php">

<div class="container">
  <main>
    <div class="py-5 text-center">
      <img class="d-block mx-auto mb-4" src="img/logo.png" alt="" width="72" height="57">
      <h2><Em>Mantenimiento de Equipo</Em></h2>
      <p class="lead">Consulta del manteminiento de los equipos.</p>
    </div>
    ...
    <div class="row g-6">
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate="">
          ...
          <button class="w-100 btn btn-dark btn-lg" type="submit">Buscar</button>
        </form>
      </div>
    </div>
  </main>
