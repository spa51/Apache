...
$result=$objconsulta->consultar_productos($num_factura);
...
<body>
<form id="form1" name="form1" method="post" action="buscar_por_categoria.php">
 ...
 <?php while ($row=mysql_fetch_array($result)){
       //  $row=mysql_fetch_array($result); ?>
  <tr>
    <td width="89" align="center"><?php echo $row['nombre'] ?></td>
  </tr>
  <?php } ?>
</table>
