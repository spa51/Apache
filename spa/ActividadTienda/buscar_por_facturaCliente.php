...
<form id="form1" name="form1" method="post" action="mostrarFacturaCliente.php">
  <p align="center" style="color: #C2FF33">INGRESE EL ID DEL CLIENTE </p>
  <table width="324" height="49" border="1" align="center">
  <!--DWLayoutTable-->
  <tr>
    <td width="144" height="27" valign="top" style="color: red" align="center">ID_CLIENTE</td>
