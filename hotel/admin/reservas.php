...
$vent=$objconsulta->mostrar_reservas($conexion);
?>
    ...
    <div class="text-center ">
      <table class="table ">
        ...
        <tbody>
          ...
          <tr>
            <td align="center">
              <?php echo $row['id_reser'] ?>
            </td>
            <td align="center">
              <?php echo $row['cedula_cli'] ?>
            </td>
            <td align="center">
              <?php echo $row['habi_reser'] ?>
            </td>
            <td align="center">
              <?php echo $row['en_fecha'] ?>
            </td>
            <td align="center">
              <?php echo $row['sa_fecha'] ?>
            </td>
            <td align="center">
              <?php echo $row['dias'] ?>
            </td>
